...
import bodyStyles from '../../styles/body2.module.css'
        ...
        <div className={bodyStyles.salute}>
          <div className={bodyStyles.container}>
            <div className={bodyStyles.halffirst}>
              <h1>AO</h1>
              <sub>UI/UX Specialist who is currently learning guitar</sub>
              <button className={bodyStyles.mainbutton}>Let's start buildling</button>
            </div>
